...
/**
 * Renderiza el botón flotante de WhatsApp en todas las páginas
 * EXCEPTO donde hay barra sticky inferior en mobile (carrito/checkout)
 * y la página /buy (que usa scroll bloqueado para el wizard).
 */
export default function ConditionalWhatsapp() {
  ...
  return (
    ...
    >
      <span className="sr-only md:hidden">Hablar por WhatsApp</span>
      <svg
