...
import { marketBreadcrumbJsonLd } from '@/lib/markets/infoPages';
import { marketBuyPath, marketPath } from '@/lib/markets/paths';
import type { MarketCode } from '@/lib/markets/types';

type SobreAlcohnPageContentProps = {
  market: MarketCode;
};

export default function SobreAlcohnPageContent({ market }: SobreAlcohnPageContentProps) {
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[0.44fr_0.56fr]">
              ...
              <div className="p-6 md:p-10 lg:p-12">
                ...
                <div className="space-y-5 text-sm md:text-base leading-relaxed text-neutral-700">
                  <p>
                    Alcohn nació en Mar del Plata como un taller de diseño industrial con una misión
                    clara: unir la precisión de la tecnología CNC con el alma artesanal de los oficios
                    tradicionales.
                  </p>
                  <p>
                    Cada sello está pensado para sentirse como una pieza de joyería industrial: una
                    herramienta duradera, clara y lista para llevar la identidad de una marca al
                    producto final.
                  </p>
                </div>
              </div>
