...
export const products: Product[] = [
  {
    ...
    materials: ['cuero'],
    images: {
      default: '/images/sello/sellologo.png',
      onLeather: '/images/sello/sellologo.png',
      onWood: '/images/sello/sellologo.png',
    },
    specs: {
      ...
      incluye: ['Sello de bronce', 'Mango ergonómico', 'Adaptacion para Remachadora'],
  ...
  },
  {
    ...
    specs: {
      ...
      incluye: ['Sello de bronce', 'Mango ergonómico', 'Adaptacion para Remachadora', 'Certificado alimenticio'],
