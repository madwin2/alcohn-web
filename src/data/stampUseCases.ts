...
export const stampUseCases: StampUseCase[] = [
  {
    ...
    productImage: '/images/clientes/elpicahueso1.webp',
    ...
    gallery: [
      { src: '/images/madera/34586fb6-7132-4e59-a481-d3485918f66c.webp', alt: 'Sello aplicado sobre madera' },
      { src: '/images/madera/DSCF1323 1.jpg.webp', alt: 'Marca en pieza de carpintería' },
      { src: '/images/madera/DSCF1834.jpg.webp', alt: 'Detalle de sello en madera' },
      { src: '/images/madera/DSCF2005.jpg.webp', alt: 'Trabajo real sobre madera' },
    ],
  ...
  },
  {
    ...
    productImage: '/images/clientes/gorila1.webp',
    ...
    gallery: [
      { src: '/images/cuero/DSCF7781.webp', alt: 'Sello aplicado sobre cuero' },
      { src: '/images/cuero/DSCF2235.webp', alt: 'Pieza de marroquinería en cuero marcada' },
      { src: '/images/cuero/DSCF1905.jpg.webp', alt: 'Detalle de marca en cuero' },
      { src: '/images/cuero/DSCF7804.webp', alt: 'Trabajo real sobre cuero' },
    ],
  ...
  },
  {
    ...
    productImage: '/images/ceramica/1.webp',
    ...
    gallery: [
      { src: '/images/ceramica/1.webp', alt: 'Sello aplicado en cerámica' },
      { src: '/images/ceramica/2.webp', alt: 'Pieza de cerámica marcada' },
      { src: '/images/ceramica/3.webp', alt: 'Detalle de marca en cerámica' },
      { src: '/images/ceramica/4.webp', alt: 'Trabajo real en cerámica' },
    ],
  ...
  },
  {
    ...
    productImage: '/images/jabon/1.webp',
    ...
    gallery: [
      { src: '/images/jabon/1.webp', alt: 'Sello aplicado sobre jabón artesanal' },
      { src: '/images/jabon/2.webp', alt: 'Jabón artesanal marcado' },
      { src: '/images/jabon/3.webp', alt: 'Detalle de marca en jabón' },
      { src: '/images/jabon/4.webp', alt: 'Trabajo real en jabón artesanal' },
    ],
  ...
  },
  {
    ...
    buyMaterial: 'otros',
    heroImage: '/images/clientes/monk2.webp',
    heroAlt: 'Packaging artesanal con marca aplicada',
    productImage: '/images/clientes/monk1.webp',
    ...
    gallery: [
      { src: '/images/clientes/monk2.webp', alt: 'Marca aplicada en packaging' },
      { src: '/images/clientes/monk1.webp', alt: 'Producto con packaging marcado' },
    ],
  ...
  },
  {
    ...
    productImage: '/images/lacre/1.webp',
    ...
    gallery: [
      { src: '/images/lacre/1.webp', alt: 'Sello aplicado en lacre' },
      { src: '/images/lacre/2.webp', alt: 'Cierre de lacre marcado' },
      { src: '/images/lacre/3.webp', alt: 'Detalle de marca en lacre' },
      { src: '/images/lacre/4.webp', alt: 'Trabajo real en lacre' },
    ],
  ...
  },
  {
    ...
    productImage: '/images/pan/1.webp',
    ...
    gallery: [
      { src: '/images/pan/1.webp', alt: 'Sello aplicado sobre pan' },
      { src: '/images/pan/2.webp', alt: 'Pan marcado con sello' },
      { src: '/images/pan/3.webp', alt: 'Detalle de marca en pan' },
      { src: '/images/pan/4.webp', alt: 'Trabajo real en pan' },
    ],
